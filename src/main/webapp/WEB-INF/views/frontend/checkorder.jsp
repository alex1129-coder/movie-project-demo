...
<head>
    ...
    <style>
        ...
        .action-btn:hover { box-shadow: 3px 3px 0 #000; transform: translate(3px, 3px); }
...
<body class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="/" class="navbar-brand"><span class="brand-text font-weight-light"><h1>文暨電影院</h1></span></a>
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a href="/#browse" class="nav-link">電影</a></li>
                        <c:choose>
                            <c:when test="${not empty sessionScope.loginUser}">
                                <li class="nav-item"><a href="/checkmovie" class="nav-link">購票</a></li>
                                <li class="nav-item"><a href="/member_menu" class="nav-link">Hi, ${sessionScope.loginUser.name}!</a></li>
                                <li class="nav-item"><a href="/logout" class="nav-link">登出</a></li>
                            </c:when>
                            <c:otherwise>
                                <li class="nav-item"><a href="/login" class="nav-link">購票</a></li>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-xl-8">
                            <div class="booking-container">
                                <div class="booking-header"><h2>Step 5: 確認訂單</h2></div>

                                <div class="ticket-summary">
                                    <div class="ticket-header"><h3>您的購票資訊</h3></div>
                                    <div class="ticket-body">
                                        <div class="ticket-section"><i class="fas fa-film"></i><h4>電影</h4><p>${showtime.movie.title}</p></div>
                                        <div class="ticket-section"><i class="fas fa-clock"></i><h4>場次</h4><p>${fn:replace(showtime.startTime, "T", " ")}</p></div>
                                        <div class="ticket-section"><i class="fas fa-users"></i><h4>人數</h4><p>${people}</p></div>
                                    </div>
                                </div>
                                ...
                                <div class="order-details">
                                    ...
                                    <p><strong>客戶名稱：</strong> ${customerName}
                                        <c:if test="${customerName eq '訪客'}">
                                            <small style="color: #6c757d;"> (請登入以綁定會員)</small>
                                        </c:if>
                                    </p>
                                ...
                                <div class="action-buttons">
                                    <a href="/seats?showtimeId=${showtime.id}&people=${people}" id="back-btn" class="action-btn">返回修改</a>
                                    <form action="/finish_order" method="get" style="display: contents;">
                                        <button type="submit" id="confirm-order-btn" class="action-btn">確認送出訂單</button>
                                    </form>
                                </div>
                            </div>
                        </div>
